                ...
                builder: (context, authProvider, child) =>
                    Column(
                      ...
                      Padding(
                        ...
                        '${getTranslated(
                            'please_enter_4_digit_code', context)}\n${widget
                            .mobileNumber}' :
                        '${getTranslated(
                            'please_enter_4_digit_code', context)}\n${widget
                            .email}',
                      ...
                      Padding(padding: const EdgeInsets.symmetric(
                        ...
                        child: PinCodeTextField(
                          ...
                          pinTheme: PinTheme(
                            ...
                            inactiveFillColor: ColorResources.getSearchBg(
                                context),
                            inactiveColor: ColorResources.colorMap[200],
                            activeColor: ColorResources.colorMap[400],
                            activeFillColor: ColorResources.getSearchBg(
                                context),
                          ),
                      ...
                      if(_seconds! <= 0)
                        Column(children: [
                          Center(child: Text(getTranslated(
                          ...
                          Center(child: InkWell(onTap: () {
                            if (widget.fromForgetPassword) {
                              ...
                              authProvider.sendOtpToEmail(
                                  ...
                                  resendOtp: true).then((value) {
                                if (value.response?.statusCode == 200) {
                                  _startTimer();
                                  showCustomSnackBar('${getTranslated(
                                      'otp_resent_successfully', context)}',
                                      context, isError: false);
                                }
                              });
                            } else if (widget.fromDigitalProduct) {
                              Provider
                                  .of<OrderDetailsController>(
                              ...
                              authProvider.sendOtpToPhone(
                                  widget.mobileNumber, widget.tempToken,
                                  fromResend: true).then((value) {
                                if (value.isSuccess) {
                                  _startTimer();
                                  showCustomSnackBar('${getTranslated(
                                      'otp_resent_successfully', context)}',
                              ...
                              child: Padding(padding: const EdgeInsets.all(
                                  ...
                                  child: Text(
                                      getTranslated('resend_code', context) ??
                                          "",
                                      style: robotoBold.copyWith(color: Theme
                                          .of(context)
                                          .primaryColor)))))
                        ]),
                      ...
                      if(_seconds! > 0)
                        Text('${getTranslated(
                            'resend_code', context)} ${getTranslated(
                            'after', context)} ${_seconds! > 0
                            ? '$minutesStr:${_seconds! % 60}'
                            : ''} ${'Sec'}'),
                                ...
                                onTap: () {
                                  Provider
                                    ...
                                    if (value.response?.statusCode == 200) {
                                      ...
                                      showCustomSnackBar(getTranslated(
                                          'input_valid_otp', context), context,
                                          isError: true);
                                    }
                                  });
                                })),
                      ...
                      if(!widget.fromDigitalProduct)
                        Padding(padding: const EdgeInsets.symmetric(
                          ...
                          CustomButton(
                            buttonText: getTranslated('verify', context),
                            // Replace your entire onTap function with this corrected version
                            onTap: () {
                              ...
                              if (phoneVerification &&
                                ...
                                authProvider.verifyOtpForResetPassword(
                                    widget.mobileNumber).then((value) {
                                  if (value.response?.statusCode == 200) {
                                ...
                                if (splashProvider.configModel
                                  ...
                                  authProvider.verifyEmail(
                                      widget.email!, widget.tempToken).then((
                                      value) {
                                    if (value.response?.statusCode == 200) {
                                      // CORRECT NAVIGATION FOR EMAIL:
                                      Navigator.pushAndRemoveUntil(context,
                                          MaterialPageRoute(builder: (
                                              _) => const DashBoardScreen()), (
                                              route) => false);
