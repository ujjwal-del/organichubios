...
class _FashionThemeHomePageState extends State<FashionThemeHomePage> {
  ...
  Future<void> _loadData(bool reload) async {
    await Provider.of<BannerController>(Get.context!, listen: false).getBannerList(Get.context!, reload);
    await Provider.of<CategoryController>(Get.context!, listen: false).getList(Get.context!, reload);
    ...
    await Provider.of<BrandController>(Get.context!, listen: false).getBrandList(Get.context!, reload);
                                  ...
                                  return InkWell(
                                    ...
                                    Dimensions.paddingSizeDefault : 0,
                                      ...
                                      child: Container(padding: const EdgeInsets.symmetric(vertical : Dimensions.paddingSizeExtraSmall,
                                          ...
                                          child: Center(child: Text('${getTranslated(productController.productTypeList[index].title ?? "new_arrival", context)}',
