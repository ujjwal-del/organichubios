...
class NotificationHelper {
  static Future<void> initialize(dynamic flutterLocalNotificationsPlugin) async {
    // Temporarily disabled flutter_local_notifications
  ...
  static Future<void> showNotification(RemoteMessage message, dynamic fln, bool data) async {
    // Temporarily disabled flutter_local_notifications
    // if(!Platform.isIOS) {
    //   String? title;
    //   String? body;
